...
<p align="center">
<i> The above test results show that the cortical brain responses are predicted by sound onset events, but not from the continuous changes in spectral flux or sound intensity when excluding the rapid increases correlating with the sound onsets. </i>
</p>
<br>
</br>
