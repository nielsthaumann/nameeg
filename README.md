...
<p align="center">
<i> The above test results show that the cortical brain responses can be predicted by sound onset events, but not from the continuous changes in spectral flux or sound intensity when excluding the rapid increases correlating with the sound onset events. </i>
</p>
<br>
</br>
